function getPOP_random_dense_equality_constrained_QCQP_on_sphere_first_order(n::Int64,data)
...
function test_test_random_dense_equality_constrained_QCQP_on_sphere_first_order(n::Int64,data)
    ...
    x,f,g,h,R=getPOP_random_dense_equality_constrained_QCQP_on_sphere_first_order(n,data)
